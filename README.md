...
Objective
The objective of this project is to develop a simple two-player Tic Tac Toe game using C. The program should allow two players to take turns, display the game board, check for valid moves, and determine the winner or a draw.
...
Make sure the .c file name in the command matches your file.
